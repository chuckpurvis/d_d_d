########################################################
#  dorling_election2020_westcoast.r
...
temp1_proj <- st_transform(temp1,4431) # BLM11N, NAD83
...
ggplot() +
  ...
  labs(title = "2020 Presidential Election Results: West Coast States",
...
ggsave("westcoast_county_presid_election_2020_2.png", plot=last_plot(),
...
ggsave("westcoast_county_presid_election_2020_1_projected.png", plot=last_plot(),
       dpi=300,width=8,height=7)   
#########################################################################################
