########################################################
#  dorling_election2020_florida.r
...
suggest_top_crs(temp1) # top suggested for Florida

temp1_proj <- st_transform(temp1,3086) # Florida GDL Albers, NAD83(2011)
...
ggsave("florida_county_presid_election_2020_2.png", plot=last_plot(),
...
ggsave("florida_county_presid_election_2020_1_projected.png", plot=last_plot(),
       dpi=300,width=8,height=7)   
#########################################################################################
