########################################################
#  dorling_election2020_midatlantic.r
...
states1 <- tigris::states(year=2020,cb=TRUE) %>% 
           filter(STUSPS %in% c("PA","NJ","MD","DE","DC")) %>% 
           st_transform(32136)
...
temp1_proj <- st_transform(temp1,32129) # Pennsylvania South, NAD83

# Dorling cartogram

carto1 <- cartogram_dorling(temp1_proj, k=2, "plurality_abs")
...
ggplot() +
  ...
  labs(title = "2020 Presidential Election Results: Mid-Atlantic States",
...
ggsave("midatlantic_county_presid_election_2020_2.png", plot=last_plot(),
...
ggsave("midatlantic_county_presid_election_2020_1_projected.png", plot=last_plot(),
       dpi=300,width=8,height=7) 
...
ggsave("midatlantic_county_presid_election_2020_0_choropleth_projected.png", plot=last_plot(),
       dpi=300,width=8,height=7)   
#########################################################################################
tempx <- temp1_proj %>% 
...
write.csv(tempx, file="midatlantic_county_presid_election_data.csv")
